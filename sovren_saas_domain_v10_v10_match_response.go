...
// SovrenSaasDomainV10V10MatchResponse sovren saas domain v10 v10 match response
//
// swagger:model Sovren.Saas.Domain.V10.V10MatchResponse
type SovrenSaasDomainV10V10MatchResponse struct {
	...
	// matches
	Matches []*SovrenMatchResult `json:"Matches"`
...
// Validate validates this sovren saas domain v10 v10 match response
func (m *SovrenSaasDomainV10V10MatchResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *SovrenSaasDomainV10V10MatchResponse) validateAppliedCategoryWeights(formats strfmt.Registry) error {
...
func (m *SovrenSaasDomainV10V10MatchResponse) validateMatches(formats strfmt.Registry) error {
...
func (m *SovrenSaasDomainV10V10MatchResponse) validateSuggestedCategoryWeights(formats strfmt.Registry) error {
...
// ContextValidate validate this sovren saas domain v10 v10 match response based on the context it is used
func (m *SovrenSaasDomainV10V10MatchResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *SovrenSaasDomainV10V10MatchResponse) contextValidateAppliedCategoryWeights(ctx context.Context, formats strfmt.Registry) error {
...
func (m *SovrenSaasDomainV10V10MatchResponse) contextValidateCurrentCount(ctx context.Context, formats strfmt.Registry) error {
...
func (m *SovrenSaasDomainV10V10MatchResponse) contextValidateMatches(ctx context.Context, formats strfmt.Registry) error {
...
func (m *SovrenSaasDomainV10V10MatchResponse) contextValidateSuggestedCategoryWeights(ctx context.Context, formats strfmt.Registry) error {
...
func (m *SovrenSaasDomainV10V10MatchResponse) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *SovrenSaasDomainV10V10MatchResponse) UnmarshalBinary(b []byte) error {
	var res SovrenSaasDomainV10V10MatchResponse
